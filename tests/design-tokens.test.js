...
const DS = 'docs/design-handoff/prototypes/_ds/juristai-design-system-dadff2d6-01b1-4a6a-87cf-c621c8a66f44/colors_and_type.css';
...
const landing = styleOf('docs/design-handoff/prototypes/landing.dc.html');
const login = styleOf('docs/design-handoff/prototypes/login.dc.html');
const dashboard = styleOf('docs/design-handoff/prototypes/dashboard.dc.html');
const ds = read(DS);
